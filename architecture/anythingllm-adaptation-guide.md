...
**Purpose:** Maps the key patterns from the [AnythingLLM deep-dive](../strategy/anythingllm-deep-dive/codex-output.md) to Cowork.ai — what we copy, what we adapt, and what we skip. Each section explains *why* a pattern changes for our architecture.

**Audience:** Engineering (Rustan + team)

**Source material:** `strategy/anythingllm-deep-dive/` (reverse-engineering of AnythingLLM's codebase)
