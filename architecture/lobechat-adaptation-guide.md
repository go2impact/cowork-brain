...
**Purpose:** Maps the key patterns from the [LobeChat deep-dive](../strategy/lobechat-deep-dive/codex-output.md) to Cowork.ai — what we copy, what we adapt, and what we skip. Each section explains *why* a pattern changes for our architecture.

**Audience:** Engineering (Rustan + team)

**Source material:** `strategy/lobechat-deep-dive/` (reverse-engineering of LobeChat's codebase)
